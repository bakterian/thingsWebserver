...
### BEGIN INIT INFO
# Provides:          ThingsWebserverDeamon
# Required-Start:    $remote_fs $named $syslog
# Required-Stop:     $remote_fs $named $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: DEBIAN initscript for node.js Mqtt forwader app
# Description:       This node js driven service is used for runing a http webserver
...
#	to add to startup do: sudo update-rc.d thingsWebserver.sh defaults		   #
#   to remove: sudo update-rc.d -f thingsWebserver.sh						   #
#   to enable: sudo update-rc.d thingsWebserver.sh enable					   #
#   to disable: sudo update-rc.d thingsWebserver.sh disable					   #
#   to start:  sudo service thingsWebserver.sh start         				   #	
#	to stop:   sudo service thingsWebserver.sh stop       					   #
# ------------------------------------------------------------------------------ 
